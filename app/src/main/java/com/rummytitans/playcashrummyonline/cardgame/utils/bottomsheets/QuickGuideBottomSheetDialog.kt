...
import com.rummytitans.playcashrummyonline.cardgame.databinding.BottomsheetDialogQuickGuideBinding
...
class QuickGuideBottomSheetDialog(context: Context,
    ...
    lateinit var binding: BottomsheetDialogQuickGuideBinding

    init {
        binding = BottomsheetDialogQuickGuideBinding.inflate(LayoutInflater.from(context),null,false)
        binding.color = color
