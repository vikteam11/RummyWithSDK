package com.rummytitans.playcashrummyonline.cardgame.ui.verifications.adapter

import android.content.Context
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.rummytitans.playcashrummyonline.cardgame.databinding.ItemVerificationOptionBinding
...
class VerificationOptionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        val binding = ItemVerificationOptionBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class OptionViewHolder(var mBinding: ItemVerificationOptionBinding) :
