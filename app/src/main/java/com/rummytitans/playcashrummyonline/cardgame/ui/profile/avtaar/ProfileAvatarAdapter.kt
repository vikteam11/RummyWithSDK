...
import com.rummytitans.playcashrummyonline.cardgame.databinding.ItemAvtarBinding
...
class ProfileAvatarAdapter(var listResponse: MutableList<ProfileAvtarItem>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        val avatarBinding = ItemAvtarBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class AvatarViewHolder internal constructor(internal var mBinding: ItemAvtarBinding) :
