package com.rummytitans.playcashrummyonline.cardgame.ui.profile.verify.adapter

import com.rummytitans.playcashrummyonline.cardgame.databinding.ItemVerfificationBinding
import com.rummytitans.playcashrummyonline.cardgame.databinding.ItemVerfificationProfileBinding
...
class ProfileVerifyItemAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
         return if(fromProfile){
            val binding = ItemVerfificationProfileBinding.inflate(LayoutInflater.from(parent.context), parent, false)
             context = parent.context
             ProfileViewHolder(binding)
        }else{
             val binding =  ItemVerfificationBinding.inflate(LayoutInflater.from(parent.context), parent, false)
             context = parent.context
    ...
    inner class VerifyViewHolder(var mBinding: ItemVerfificationBinding) :
    ...
    inner class ProfileViewHolder(var mBinding: ItemVerfificationProfileBinding) :
        BaseViewHolder(mBinding.root) {
        override fun onBind(position: Int) {
            mBinding.data = listResponse[position]
