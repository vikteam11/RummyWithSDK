...
import com.rummytitans.playcashrummyonline.cardgame.databinding.ItemAadhaarVerifyNoteBinding
...
class AadhaarVerifyNoteAdapter(
   ...
   val showCheckBox:Boolean = false) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        val binding = ItemAadhaarVerifyNoteBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ReferViewHolder(var mBinding: ItemAadhaarVerifyNoteBinding) :
