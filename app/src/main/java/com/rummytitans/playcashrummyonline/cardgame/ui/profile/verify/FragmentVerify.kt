...
import com.rummytitans.playcashrummyonline.cardgame.databinding.FragmentVerifyBinding
...
import kotlinx.android.synthetic.main.dialog_for_delete_bank.*
...
class FragmentVerify : BaseFragment(),
    ...
    override fun onCreateView(
        ...
        binding = FragmentVerifyBinding.inflate(localInflater ?: inflater, container, false).apply {
        ...
        dialogChangeEmail = viewModel.myDialog?.getMyDialog(R.layout.dialog_edit_email)
    ...
    fun showBankDeletePopup() {
        activity?.let {
            val dialog = MyDialog(it).getMyDialog(R.layout.dialog_for_delete_bank)
            dialog.show()
