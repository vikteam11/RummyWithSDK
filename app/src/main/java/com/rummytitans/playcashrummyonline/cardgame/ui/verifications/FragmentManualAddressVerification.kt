...
import com.rummytitans.playcashrummyonline.cardgame.databinding.FragmentAddressVerifyManualBinding
...
class FragmentManualAddressVerification : BaseFragment(), AddressVerificationNavigator,
    ...
    lateinit var binding: FragmentAddressVerifyManualBinding
    ...
    override fun onCreateView(
        ...
        binding =
            FragmentAddressVerifyManualBinding.inflate(localInflater ?: inflater, container, false)
                .apply {
    ...
    override fun showChooseUploadSheet(uploadType: Int) {
        BottomSheetDialogBinding<BottomsheetDialogChoosePicBinding>(
            requireContext(),
            R.layout.bottomsheet_dialog_choose_pic
        ).apply {
