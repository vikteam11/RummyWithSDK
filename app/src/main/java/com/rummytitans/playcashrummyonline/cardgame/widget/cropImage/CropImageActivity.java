...
package com.rummytitans.playcashrummyonline.cardgame.widget.cropImage;
...
import com.rummytitans.playcashrummyonline.cardgame.databinding.CropImageActivityBinding;
...
public class CropImageActivity extends AppCompatActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    binding = DataBindingUtil.setContentView(this, R.layout.crop_image_activity);
    ...
    binding.tvDone.setOnClickListener(view -> cropImage());

    binding.tvCancel.setOnClickListener(view -> onBackPressed());
  }
