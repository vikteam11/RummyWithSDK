...
import com.rummytitans.playcashrummyonline.cardgame.databinding.ActivityUpdatePhoneBinding
...
class UpdatePhoneActivity : BaseActivity(),UpdatePhoneNavigator {
    private lateinit var mBinding: ActivityUpdatePhoneBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = DataBindingUtil.setContentView<ActivityUpdatePhoneBinding>(this, R.layout.activity_update_phone).apply{
