...
import com.rummytitans.playcashrummyonline.cardgame.databinding.FragmentAddressVerifyWithAadhaarBinding
...
class AutomaticAddressVerificationFragment : BaseFragment(), AddressVerificationNavigator {
    ...
    lateinit var binding: FragmentAddressVerifyWithAadhaarBinding
    ...
    override fun onCreateView(
        ...
        binding =
            FragmentAddressVerifyWithAadhaarBinding.inflate(localInflater ?: inflater, container, false)
                .apply {
