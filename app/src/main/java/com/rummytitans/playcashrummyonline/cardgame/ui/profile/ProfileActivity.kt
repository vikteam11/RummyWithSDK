...
import com.rummytitans.playcashrummyonline.cardgame.databinding.ActivityProfileBinding
import com.rummytitans.playcashrummyonline.cardgame.databinding.DialogUpdateTeamNameBinding
...
import com.rummytitans.playcashrummyonline.cardgame.ui.profile.verify.adapter.ProfileVerifyItemAdapter
...
import com.rummytitans.playcashrummyonline.cardgame.databinding.BottomsheetDialogChoosePicBinding
import com.rummytitans.playcashrummyonline.cardgame.databinding.BottomsheetUpdateAvtarBinding
import com.rummytitans.playcashrummyonline.cardgame.databinding.BottomsheetUpdateAvtarDialogBinding
import com.rummytitans.playcashrummyonline.cardgame.ui.profile.avtaar.AvtarNavigator
import com.rummytitans.playcashrummyonline.cardgame.ui.profile.avtaar.ProfileAvatarListAdapter
import com.rummytitans.playcashrummyonline.cardgame.ui.profile.avtaar.ProfileAvtarItem
import com.rummytitans.playcashrummyonline.cardgame.ui.profile.avtaar.ProfileAvtarModel
...
import kotlinx.android.synthetic.main.dialog_update_team_name.*
...
class ProfileActivity : BaseActivity(), ProfileSelectListener, DBUpdateNavigortor,AvtarNavigator {
    ...
    private var mTeamUpdateBinding: DialogUpdateTeamNameBinding? = null
    ...
    private fun initClick(){
        ...
        binding.bottomSheetUpdateAvtar.btnChangeAvtar.setOnClickListenerDebounce(1500) {
        ...
        binding.bottomSheetUpdateAvtar.imgCross.setOnClickListenerDebounce {
        ...
        binding.txtVerifyAccount.setOnClickListener {
            ...
            // TODO : handle varification part on commonfragment activity
    ...
    private fun setAvatarAdapter() {
        ...
        if(avatarListAdapter == null){
            avatarListAdapter = ProfileAvatarListAdapter(list,this)
        }
        binding.bottomSheetUpdateAvtar.recyclerAvatars.adapter = avatarListAdapter
    }
    ...
    private fun getAvtarList(): ArrayList<ProfileAvtarModel> {
        ...
        val imageArray = resources.obtainTypedArray(R.array.avatar_image)
    ...
    fun updateProfileTeamName(v: View) {
        ...
        mTeamUpdateBinding =
            DataBindingUtil.inflate(layoutInflater, R.layout.dialog_update_team_name, null, false)
                ...
                isTeamAvailable.observe(this@ProfileActivity, Observer {
                    inputTeamName.apply {
                        if (!TextUtils.isEmpty(teamName.get())) {
                            val (msg, color) = if (it)
                                Pair(R.string.txt_team_name_correct, R.color.maingreen)
                            else
    ...
    private var avatarDialog:BottomSheetDialogBinding<BottomsheetUpdateAvtarDialogBinding>? = null
    ...
    private fun bottomSheetListener(){
        avatarDialog =  BottomSheetDialogBinding<BottomsheetUpdateAvtarDialogBinding>(
            this,
            R.layout.bottomsheet_update_avtar_dialog
        ).apply {
