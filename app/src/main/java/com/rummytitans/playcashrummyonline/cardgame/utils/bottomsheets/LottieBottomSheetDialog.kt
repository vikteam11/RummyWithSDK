...
import com.rummytitans.playcashrummyonline.cardgame.databinding.BottomsheetDialogLottieBinding
...
class LottieBottomSheetDialog(
    ...
    var binding: BottomsheetDialogLottieBinding =
        BottomsheetDialogLottieBinding.inflate(LayoutInflater.from(context),null,false)
