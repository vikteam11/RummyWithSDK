...
import com.rummytitans.playcashrummyonline.cardgame.databinding.FragmentWebviewsBinding
...
class WebViewActivity : AppCompatActivity() {
    ...
    lateinit var binding: FragmentWebviewsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.fragment_webviews)
                ...
                webViewClient = object : WebViewClient() {
                    ...
                    override fun shouldOverrideUrlLoading(view: WebView?, url: String?): Boolean {
                        return if (url.toString().contains("sportstiger.app.link")) {
                            ...
                            if(url.toString().contains("goBack"))
                                finish()
                            else
                                openDeeplink(url.toString())
                            true
                        }else if (url.toString().contains("${MyConstants.AppDeeplink_}:")) {
                            if(url.toString().contains("goBack"))
                                finish()
                            else
                                openDeeplink(url.toString())
...
// TODO: handel deeplink from webview
